/*
    Target database:    ContosoUniversity.Db (configurable)
    Target instance:    (any)
...
IF @baselineRequired = 1
  BEGIN
    PRINT '----- baselined: Migrations\1.0.0-Baseline\001_20180307-0854_arodriguez.sql (marked as deployed) -----';
    ...
    VALUES                                         (CAST ('731d617d-f764-4ce6-980c-49008fe96b94' AS UNIQUEIDENTIFIER), 'DDB697F6C439FA4ED18DC73AB60CA818DF30012DAB1D36B8D93B944B268C1153', 'Migrations\1.0.0-Baseline\001_20180307-0854_arodriguez.sql', SYSDATETIME(), SYSTEM_USER, 0, '1.0.0-Baseline', '$(PackageVersion)', CASE '$(ReleaseVersion)' WHEN '' THEN NULL ELSE '$(ReleaseVersion)' END);
  END
...
GO
IF NOT EXISTS (SELECT 1 FROM [$(DatabaseName)].[dbo].[__MigrationLogCurrent] WHERE [migration_id] = CAST ('731d617d-f764-4ce6-980c-49008fe96b94' AS UNIQUEIDENTIFIER))
  PRINT '
...
GO
EXECUTE ('PRINT N''Creating [dbo].[Course]''
');

GO
EXECUTE ('CREATE TABLE [dbo].[Course]
(
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_Course] on [dbo].[Course]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Course] ADD CONSTRAINT [PK_Course] PRIMARY KEY CLUSTERED  ([CourseID])
');

GO
EXECUTE ('PRINT N''Creating index [IX_Course_DepartmentID] on [dbo].[Course]''
');

GO
EXECUTE ('CREATE NONCLUSTERED INDEX [IX_Course_DepartmentID] ON [dbo].[Course] ([DepartmentID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[Person]''
');
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_Instructor] on [dbo].[Person]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Person] ADD CONSTRAINT [PK_Instructor] PRIMARY KEY CLUSTERED  ([ID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[Department]''
');
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_Department] on [dbo].[Department]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Department] ADD CONSTRAINT [PK_Department] PRIMARY KEY CLUSTERED  ([DepartmentID])
');

GO
EXECUTE ('PRINT N''Creating index [IX_Department_InstructorID] on [dbo].[Department]''
');

GO
EXECUTE ('CREATE NONCLUSTERED INDEX [IX_Department_InstructorID] ON [dbo].[Department] ([InstructorID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[CourseAssignment]''
');

GO
EXECUTE ('CREATE TABLE [dbo].[CourseAssignment]
(
[CourseID] [int] NOT NULL,
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_CourseAssignment] on [dbo].[CourseAssignment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[CourseAssignment] ADD CONSTRAINT [PK_CourseAssignment] PRIMARY KEY CLUSTERED  ([CourseID], [InstructorID])
');

GO
EXECUTE ('PRINT N''Creating index [IX_CourseAssignment_InstructorID] on [dbo].[CourseAssignment]''
');

GO
EXECUTE ('CREATE NONCLUSTERED INDEX [IX_CourseAssignment_InstructorID] ON [dbo].[CourseAssignment] ([InstructorID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[Enrollment]''
');

GO
EXECUTE ('CREATE TABLE [dbo].[Enrollment]
(
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_Enrollment] on [dbo].[Enrollment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Enrollment] ADD CONSTRAINT [PK_Enrollment] PRIMARY KEY CLUSTERED  ([EnrollmentID])
');

GO
EXECUTE ('PRINT N''Creating index [IX_Enrollment_CourseID] on [dbo].[Enrollment]''
');

GO
EXECUTE ('CREATE NONCLUSTERED INDEX [IX_Enrollment_CourseID] ON [dbo].[Enrollment] ([CourseID])
');

GO
EXECUTE ('PRINT N''Creating index [IX_Enrollment_StudentID] on [dbo].[Enrollment]''
');

GO
EXECUTE ('CREATE NONCLUSTERED INDEX [IX_Enrollment_StudentID] ON [dbo].[Enrollment] ([StudentID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[OfficeAssignment]''
');

GO
EXECUTE ('CREATE TABLE [dbo].[OfficeAssignment]
(
[InstructorID] [int] NOT NULL,
...
GO
EXECUTE ('PRINT N''Creating primary key [PK_OfficeAssignment] on [dbo].[OfficeAssignment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[OfficeAssignment] ADD CONSTRAINT [PK_OfficeAssignment] PRIMARY KEY CLUSTERED  ([InstructorID])
');

GO
EXECUTE ('PRINT N''Creating [dbo].[__EFMigrationsHistory]''
');

GO
EXECUTE ('CREATE TABLE [dbo].[__EFMigrationsHistory]
(
...
GO
EXECUTE ('PRINT N''Creating primary key [PK___EFMigrationsHistory] on [dbo].[__EFMigrationsHistory]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[__EFMigrationsHistory] ADD CONSTRAINT [PK___EFMigrationsHistory] PRIMARY KEY CLUSTERED  ([MigrationId])
');

GO
EXECUTE ('PRINT N''Adding foreign keys to [dbo].[CourseAssignment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[CourseAssignment] ADD CONSTRAINT [FK_CourseAssignment_Course_CourseID] FOREIGN KEY ([CourseID]) REFERENCES [dbo].[Course] ([CourseID]) ON DELETE CASCADE
');

GO
EXECUTE ('ALTER TABLE [dbo].[CourseAssignment] ADD CONSTRAINT [FK_CourseAssignment_Instructor_InstructorID] FOREIGN KEY ([InstructorID]) REFERENCES [dbo].[Person] ([ID]) ON DELETE CASCADE
');

GO
EXECUTE ('PRINT N''Adding foreign keys to [dbo].[Enrollment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Enrollment] ADD CONSTRAINT [FK_Enrollment_Course_CourseID] FOREIGN KEY ([CourseID]) REFERENCES [dbo].[Course] ([CourseID]) ON DELETE CASCADE
');

GO
EXECUTE ('ALTER TABLE [dbo].[Enrollment] ADD CONSTRAINT [FK_Enrollment_Person_StudentID] FOREIGN KEY ([StudentID]) REFERENCES [dbo].[Person] ([ID]) ON DELETE CASCADE
');

GO
EXECUTE ('PRINT N''Adding foreign keys to [dbo].[Course]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Course] ADD CONSTRAINT [FK_Course_Department_DepartmentID] FOREIGN KEY ([DepartmentID]) REFERENCES [dbo].[Department] ([DepartmentID]) ON DELETE CASCADE
');

GO
EXECUTE ('PRINT N''Adding foreign keys to [dbo].[Department]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[Department] ADD CONSTRAINT [FK_Department_Instructor_InstructorID] FOREIGN KEY ([InstructorID]) REFERENCES [dbo].[Person] ([ID])
');

GO
EXECUTE ('PRINT N''Adding foreign keys to [dbo].[OfficeAssignment]''
');

GO
EXECUTE ('ALTER TABLE [dbo].[OfficeAssignment] ADD CONSTRAINT [FK_OfficeAssignment_Instructor_InstructorID] FOREIGN KEY ([InstructorID]) REFERENCES [dbo].[Person] ([ID]) ON DELETE CASCADE
');
