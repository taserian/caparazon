...
$FinalTargetDatabase = 'ContosoUniversity.Db'
$OctoOptionDeployToLocalInstance = ''
$SkipVariableValidation = ''
$__isAzurePlatformTarget = 'False'
$CreateScriptFileName = 'ContosoUniversity.Db_Package.sql'
$SnapshotPackageFileName = 'ContosoUniversity.Db_Snapshot.nupkg.bin'
